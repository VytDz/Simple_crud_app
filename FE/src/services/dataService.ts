...
export const create = (data: { name: string; lastName: string; timeStamp: string; }) => http.post('/appointments', data);
export const update = (id: string, data: { name: string; lastName: string; timeStamp: string; }) => http.put(`/appointments/${id}`, data);
